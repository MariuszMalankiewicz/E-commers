...
<div class="flex flex-col items-center justify-center h-screen">
    ...
    <form action="" method="post" id="addUser" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="username" value="<?php if(isset($_POST['registration'])){ echo $_POST['username'];} ?>" placeholder="Username" minlength="3" maxlength="12" required>
        <?php
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="email" name="email" value="<?php if(isset($_POST['registration'])){ echo $_POST['email'];} ?>" placeholder="Email" required>
        <?php
            if(isset($_POST['registration']))
            {
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" type="password" name="password" value="<?php if(isset($_POST['registration'])){ echo $_POST['password'];} ?>" placeholder="******************" minlength="8" maxlength="20" required>
        </div>
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" type="password" name="repassword" value="<?php if(isset($_POST['registration'])){ echo $_POST['repassword'];} ?>" placeholder="******************" minlength="8" maxlength="20" required>
        <?php
            if(isset($_POST['registration']))
            {
